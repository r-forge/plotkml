...
# Maintainer     : Dylan Beaudette (debeaudette@ucdavis)
# Contributions  : Tomislav Hengl (tom.hengl@wur.nl).edu); Pierre Roudier (pierre.roudier@landcare.nz)
# Status         : not tested yet
# Note           : This function should reduce all possible incompatibilities and conflicts
