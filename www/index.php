...
<p class="style1">Contributions by: <a href="http://www.landcareresearch.co.nz/research/staff_page.asp?staff_num=2132" target="_blank">Pierre Roudier</a>, <a href="http://casoilresource.lawr.ucdavis.edu/drupal/node/905" target="_blank">Dylan Beaudette</a> &amp; Edzer Pebesma </p>
...
<p>Get the <a href="http://cran.at.r-project.org/package=plotKML" target="_blank"><strong>stable release from CRAN</strong></a>. <img src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=http://cran.at.r-project.org/package=plotKML" alt="" title="plotKML on CRAN"></p>
