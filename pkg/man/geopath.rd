...
\details{Number of points between the start and end point is derived using: \code{round(sqrt(distc)/sqrt(2), 0)} where \code{distc} is the Great Circle Distance.}
