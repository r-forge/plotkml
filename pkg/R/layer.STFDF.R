...
#       print(str(obj))
#       print(str(TimeSpan.begin))
#       print(str(TimeSpan.end))
...
#         }
#   else { 
#   stop("The slot 'sp' of the STFDF object does not extend SpatialPixels*, SpatialPoints*, SpatialLines* or SpatialPolygons*")
#   }}}}
# 
# }
